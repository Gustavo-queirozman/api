...
router.get('/produto?:nome', ControllerProduto.buscarProduto);//buscar produto pelo nome
router.get('/produto?:categoria', ControllerProduto.buscarCategoria);//buscar produto pela categoria
